...
analysis_tab, watch_tab, paper_tab, backtest_tab, options_tab = st.tabs([
    "Price vs EPS", "Watchlists", "Paper Trading", "Backtesting", "Options Finder"
])
...
with watch_tab:
    category = st.selectbox("Watchlist", list(CATEGORY_LISTS))
    ...
    if selected_rows:
        ...
        st.success(f"{selected} loaded into Stock Analysis and Options Finder. Open those tabs to continue.")
